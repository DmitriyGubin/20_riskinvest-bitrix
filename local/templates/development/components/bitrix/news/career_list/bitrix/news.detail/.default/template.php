...
//debug($arResult);
$APPLICATION->SetPageProperty("title", $arResult['NAME'].' - РИСКИНВЕСТ');
?>
...
<section class="position wrap">
	...
	<div class="all">
		<h2 class="pos_title">Обязанности</h2>
		<div class="pos_text">
			<?= $arResult['PROPERTIES']['RESPONSIBILITIES']['~VALUE']['TEXT']; ?>
		</div>

		<h2 class="pos_title">Требования</h2>
		<div class="pos_text">
			<?= $arResult['PROPERTIES']['REQUIREMENTS']['~VALUE']['TEXT']; ?>
		</div>

		<h2 class="pos_title">Условия</h2>
		<div class="pos_text">
...
<?php $title = 'ЖДЕМ ВАШЕ РЕЗЮМЕ НА ПОЧТУ:'; ?>
<?
