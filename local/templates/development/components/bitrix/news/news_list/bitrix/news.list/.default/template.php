...
<section class="newss wrap">
	<h1 class="title">Новости компании</h1>
	
	<div class="news_box">
	<?foreach($arResult["ITEMS"] as $arItem):?>
	<?php $ref = $arItem['DETAIL_PAGE_URL']; ?>
		<a class="news_item hover_box" href="<?= $ref; ?>">
			<div>
				<div class="date"><?= str_replace('.', '/', $arItem['ACTIVE_FROM']); ?></div>
				<div class="news_title">
					<?= ($arItem['PROPERTIES']['BANKROTSTVO'] == '')?'НОВОСТИ КОМПАНИИ':'НОВОСТИ БАНКРОТСТВА'; ?>	
				</div>
				<div class="news_text">
					<?= $arItem['NAME']; ?>
				</div>
