...
<section class="detail wrap">
	...
	<div class="about_box">
		<div class="text_box">
			...
			<?php $next_ref = Next_News_Check(4,$arResult['ACTIVE_FROM']); ?>

			<?php if($next_ref != 'no'): ?>
			<a class="another_item" href="<?= $next_ref; ?>">
				<div>Следующий кейс</div>
...
<?php 
	$id = $arResult['ID'];
	$another = Return_All(
		Array("IBLOCK_ID"=>4, "ACTIVE"=>"Y", "!ID" => $id),
...
?>
		...
		<div class="another">
			<div class="another_title">Другие кейсы</div>
			...
			<div class="anoth_slide">
				<a href="<?= $ref; ?>" class="anoth_item hover_box">
